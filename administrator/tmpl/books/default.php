...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_employee&task=books.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_employee&view=books'); ?>" method="post"
			...
			<?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
				...
				<table class="table table-striped" id="employeeList">
					...
					<th  scope="col" class="w-1 text-center">
						...
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_EMPLOYEE_BOOKS_TITLE', 'a.booktitle', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_EMPLOYEE_BOOKS_AUTHOR', 'a.bookauthor', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_EMPLOYEE_BOOKS_PUBLISHER', 'a.bookpublisher', $listDirn, $listOrder); ?>
						</th>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_employee&task=book.edit&id='.(int) $item->id); ?>">
									<?php echo $this->escape($item->booktitle); ?>
									</a>
								<?php else : ?>
												<?php echo $this->escape($item->booktitle); ?>
								<?php endif; ?>
